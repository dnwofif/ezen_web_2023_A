/*
	...
	배열 : 데이터 여러개를 한곳에 저장할 수 있는 공간/메모리/상자
		...
		8. 배열내 데이터 삭제
				...
				ex)
					배열명.splice(0) 		: 0번 인덱스로부터 마지막인덱스까지 삭제
	...
	*/
	...
	document.write(배열명)
	// 예제3 : 인덱스 사용
	document.write('<h3>과일 개수 : ' + 배열명.length +'</h3>')
	document.write('<ol>')	// HTML 문자처리o
	document.write(	'	<li>'+배열명[0]+'</li>' )	// 변수 or 배열 문자처리 x
	document.write(	'	<li>'+배열명[1]+'</li>' )	// 변수 or 배열 문자처리 x
	document.write(	'	<li>'+배열명[2]+'</li>' )	// 변수 or 배열 문자처리 x
	document.write(	'	<li>'+배열명[3]+'</li>' )	// 변수 or 배열 문자처리 x
	document.write('</ol>')	// HTML 문자처리
	
	// 예제4 : 인덱스를 이용한 데이터 수정
	console.log(배열명[0]);	//수정전
	배열명[0] = '수박';
	console.log(배열명[0]);	//수정후
	...
	배열명.splice(배열명.indexOf('딸기'),1)	// '딸기' 삭제 하는데 인덱스번호를 모른 상태
		//1. 배열명.indexOf('딸기') => 2
