...
console.log( int1 +'  '+int2 + '  ' + int3 )
 ...
 //문제5 : 4개의 정수 를 입력받아서 오름차순 / 내림차순 출력 (미완성)
 let int4  = Number(prompt('정수1 : '));
 let int5  = Number(prompt('정수2 : '));
 let int6  = Number(prompt('정수3 : '));
 let int7  = Number(prompt('정수4 : '));
 //if문으로 int4랑 int5를 비교하기
 //if문으로 int4랑 int6를 비교하기
 //if문으로 int4랑 int7를 비교하기
