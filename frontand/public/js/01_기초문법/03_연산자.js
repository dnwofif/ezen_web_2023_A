...
//3. 관계연산자
console.log('이면서 : ' + (10>3 && 20>15)) //10은 4보다 크면서 20은 15보다 크다 . // true and true
...
/*  -문제4 : prompt 함수 로 정수를 입력받아 홀수[true] / 짝수[false] 여부 출력
		*홀수 : 수%2 == 1
			어떤 수의 나누기 2을 했을 때 나머지가 1이면 그 수는 홀수 이다.
		*짝수 : 수%2 == 0
			어떤 수의 나누기 2을 했을 때 나머지가 0이면 그 수는 짝수 이다.
 ...
 //문제5
 let 정수2 = prompt('정수 2 : '); console.log('입력받은 정수2 : ' + (정수2%7 == 0));
 //문제6
...
console.log('data : ' + (데이터2++))	//10에서 1증가 => 11???? 10	[출력후에 증가]
...
console.log('38의 연락구간 : ' +연령구간)

	//예제2 [조건1 ? 참1 : 조건2 ? 참2 : 조건3 ? 참3 : 거짓]
let 점수 = 78
let 등급 = 점수 >= 90 ? 'A등급' : 점수 >=80 ? 'B등급' : 점수>= 70 ? 'C등급' : '탈락';
	// 조건1 ? '참1' : 		조건2 ? '참2'			조건3?'참3' : 거짓
console.log('점수의 동급 : ' + 등급)

//문제9 : 정수 2개를 입력받아 더 큰수 를 출력
let value1 = prompt('정수1 : ')
let value2 = prompt('정수2 : ')
console.log('더 큰수는 ' + (value1>value2 ? value1 : value2));
console.log('더 큰수는 ' + (value1>value2 ? value1 : value1<value2 ? value2 : '두 수는 같다'));
...
let value5 = prompt('정수3 : ')
	//변수활용
let max = value3 					//1. max 변수에 첫번째 입력값 지정한다.
...
let value6 = prompt('정수1 : ')
let value7 = prompt('정수2 : ')
let value8 = prompt('정수3 : ')




console.log('정수를 큰 것부터 : ')