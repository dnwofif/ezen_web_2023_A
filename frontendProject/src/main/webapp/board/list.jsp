...
<body>
		...
		부트스트랩 : 미리 만들어진 css/js 빠르게 적용
			...
			- 
				...
				2. 그리드 : 해당 구역 12조각
					...
					.col : 열
					.col-조각수 : 열-조각수
					.justitfy-content-md-center : 가로배치 가로정렬
	...
	<!-- css/js 관련 라이브러리(미리만들어진 css/js -->
	
	<div class="container"><!-- 현재 게시물출력 페이지 전체 구역 -->
		<a href="write.jsp"><button type="button" class="btn btn-info">글쓰기</button></a>
		<table class="table table-striped table-hover text-center"><!-- 테이블 -->
			<thead>
				<tr><!-- 제목행 -->
					<th width="5%"> 번호 </th><th width="50%"> 제목 </th>		<th width="10%"> 작성자 </th>		
					<th width="10%"> 작성일 </th>			<th width="10%"> 작성자 </th>		<th width="10%"> 추천수 </th>
				</tr>
			</thead>
			<tbody>
				<!-- boardPrint 함수에서 호출 -->
