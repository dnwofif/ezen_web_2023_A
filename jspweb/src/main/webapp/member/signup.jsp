...
<body>
	...
	<div class="webcontainer"> <!-- 회원가입 전체 구역  -->
		<form class="signupForm"> <!-- 폼 전송시 각 input에 name속성 -->
			아이디 : <input maxlength="30" onkeyup="idcheck() " name="mid" class="mid"  type="text" /> 
			<span class="idcheckbox"></span>
			<br/>
			
			비밀번호 : <input maxlength="20" onkeyup="pwcheck()" name="mpwd" class="mpwd" type="password" /> <br/>
			비밀번호 확인 : <input maxlength="20" onkeyup="pwcheck()"  class="mpwdconfirm" type="password" />
