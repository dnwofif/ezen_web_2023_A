...
public class Calculator {//class s
	...
	//3. 메소드 : 객체의 동작 [*객체간의 상호작용]
		...
		//2. 메소드명 : 소문자시작, 카멜표기법
		//3. 매게변수 : 메소드 호출 할때 전달한 매개값
		//4. { } : 메소드 호출시 실행되는 구역/부분
	
		//1. 리턴이 없는 메소드	리턴x 매개변수x
	void powerOn() {
