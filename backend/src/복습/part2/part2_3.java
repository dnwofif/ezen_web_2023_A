	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(ch==1) {
				...
				else {System.out.println("안내)콜라 재고가 없습니다. [관리자에게문의]");}
			}else if(ch==2){
				if(환타재고>0) {환타바구니++;	환타재고--; System.out.println("안내)환타 담았습니다.");}
				else {System.out.println("안내)환타 재고가 없습니다. [관리자에게문의]");}
			}else if(ch==3) {
				if(사이다재고>0) {사이다바구니++;	사이다재고--; System.out.println("안내)사이다 담았습니다.");}
				else {System.out.println("안내)사이다 재고가 없습니다. [관리자에게문의]");}
			}else if(ch==4) {
				System.out.println("-------------------------------");
				System.out.printf("%3s %2s %5s\n","제품명","수량","가격");
				if(콜라바구니>0)System.out.printf("%3s %2s %5d\n","콜라",콜라바구니,콜라바구니*콜라가격);
				if(환타바구니>0)System.out.printf("%3s %2s %5d\n","환타",환타바구니,환타바구니*환타가격);
				if(사이다바구니>0)System.out.printf("%3s %2s %5d\n","사이다",사이다바구니,사이다바구니*사이다가격);
