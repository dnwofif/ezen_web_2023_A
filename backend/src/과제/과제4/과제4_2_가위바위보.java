...
public class 과제4_2_가위바위보 {
	...
	public static void main(String[] args) {
		...
		int 플레이어승리수 = 0 ; int 컴퓨터승리수 = 0 ;//승리할대마다 승리수를 저장하는 변수 역할
		...
		while(true) {
			...
			//step3 : 종료코드를 넣어주는 시점[난수 x 승리자판단 x]
			if(플레이어 == 3) {
				
				System.out.println("게임수 : "+게임수);//경우의수 없는 ㅜㄹ력
			...
			// step1
			// 컴퓨터수는난수로 자동 생성 한다. [Math.random () vs new Random(); ]
				//1. 랜덤 객체 생성
			...
			// 승리 : 가위&&보 || 바위&&가위 || 보&&바위
			if (플레이어==0 && 컴퓨터==2 || 플레이어==1 && 컴퓨터==0 || 플레이어==2 && 컴퓨터==1 ) {System.out.println("플레이어 승리");플레이어승리수++;}
			// 무승부 : 가위&&가위 || 바위&&바위 || 보&&보
