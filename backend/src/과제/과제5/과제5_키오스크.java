...
public class 과제5_키오스크 {
	...
	public static void main(String[] args) {
		...
		//3. 임의의 구분(문자)를 기준으로 분리 = .split()
			//"10,0,300,10,0,200,10,0,100"; --> \n --> 조각수 4조각
				// 1조각 : 10,0,300		// 2조각 : 10,0,200		// 3조각 : 10,0,100
		...
		while(true) {
			...
			/* 문제풀이 위치 */
			//step1 : 메뉴 번호 선택/입력에 따른 서로 다른 실행/코드
			if( ch == 1) {//1.콜라 선택
				//step2 : 기능 구현
				...
				if(ch2==1) {//1. 결제 선택
					...
					//2. 만약에 총가격보다 입력받은 금액이 더 크거나 같으면 성공 / 아니면 실패
					if(pay >= 총가격) {
						System.out.println("잔액 : "+(pay-총가격));
						//구매성공 // 장바구니초기화 = 다음 사람을 위해
